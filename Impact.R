...
baseDir = "c"
tickers = c( "AAPL", "GE")#"INTC","CSCO","YHOO","GOOG","MGM","ORCL","AMZN","EBAY","AMD","DELL","AA","AMG#N","GM","IBM","RIMM","HD","MS","QCOM")

startDate = 20070620
endDate = 20070622   # Get all available dates of 2007
dates = quoteDates( baseDir, 20070620, 20070622 )
numBuckets=26
retMat = getRet(baseDir,tickers,dates,numBuckets)